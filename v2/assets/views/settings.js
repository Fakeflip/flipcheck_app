...
const SettingsView = (() => {
  ...
  async function mount(container) {
    ...
    // Nur noch existierende Tabs zulassen (alte "marketplaces"/"shipping" → general)
    _activeTab = ["general", "calculation", "system"].includes(settings._lastSettingsTab)
      ? settings._lastSettingsTab : "general";
